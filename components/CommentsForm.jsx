...
const CommentsForm = ({slug}) => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 gap-4 mb-4">
          ...
          className="p-4 outline-none w-full rounded-lg h-40 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 
          text-gray-700" placeholder="Name" name="name" />
          ...
          focus:ring-gray-200 bg-gray-100 text-gray-700" placeholder="Email" name="email" />
        </div>
        <div className="grid grid-cols-1 gap-4 mb-4">
          <div>
        ...
        font-medium rounded-full text-white px-8 py-3 cursor-pointer">Post Comment</button>
        {showSuccessMessage && 
